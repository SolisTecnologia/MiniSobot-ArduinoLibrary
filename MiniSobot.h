...
class MiniSobot
{
  public:
   ...
   // RED, GREEN BLUE with range 0 at 255 and have optional parameter to turn led off
    ...
    // If not set duration, the buzzer play forever.
    void buzzer (int frequency, int duration = 0);
    ...
    // Drive in forward, at speed and duration defined by parameter
    // The range of values go 0 to 255, but values below 100 not are recommended
    void drive_forward(int speed = 255, int duration = 0);

    // Drive in backward, at speed and duration defined by parameter
    // The range of values go 0 to 255, but values below 100 not are recommended
    void drive_backward(int speed = 255, int duration = 0);
    ...
    void drive_curve_differential_right(int speed, int percent);
    ...
    void drive_curve_differential_left(int speed, int percent);
